...
template<typename RegAccessConfig::Address RegisterAddress = 0x12010000>
struct PllConfig_0_6 : public Register::Description<RegAccessConfig, RegisterAddress> {
...
struct PllConfig0 : public PllConfig_0_6<0x12010000> {};
// PERI_CRG_PLL6 is VPLL configuration register 6.
struct PllConfig6 : public PllConfig_0_6<0x12010018> {};

// PERI_CRG_PLL1/PERI_CRG_PLL7 is APLL/VPLL configuration register 1/7.
template<typename RegAccessConfig::Address RegisterAddress = 0x12010004>
struct PllConfig_1_7 :  public Register::Description<RegAccessConfig, RegisterAddress> {
        ...
        enum class TDsmPowerDown {
                DecimalMode,
                IntegerMode
        };
        struct DsmPowerDown : public Bit < 24, TDsmPowerDown > {};
...
struct PllConfig1 :  public PllConfig1<0x12010000> {};
// PERI_CRG_PLL7 is VPLL configuration register 7.
struct PllConfig7 :  public PllConfig1<0x1201001C> {};
...
struct SocClkSel : public Register::Description<RegAccessConfig, 0x12010078> {
        ...
        struct SysCfgClk : public <6,TSysCfgClk> {};
        ...
        struct CoreA7ClkSel : public Filed<1,0, TCoreA7ClkSel> {};
};
...
struct PllLockStatus : public Register::Description<RegAccessConfig, 0x120101E8 > {
        ...
        struct VPll : public Bit<0, TAPll> {};
}
...
constexpr const Register::Class< Descr::PllConfig0>             PllConfig0;
constexpr const Register::Class< Descr::PllConfig1>             PllConfig1;
constexpr const Register::Class< Descr::PllConfig6>             PllConfig6;
constexpr const Register::Class< Descr::PllConfig7>             PllConfig7;
constexpr const Register::Class< Descr::PllASpectrumSpread>     PllASpectrumSpread;
constexpr const Register::Class< Descr::ResetConfig>            ResetConfig;
constexpr const Register::Class< Descr::SocClkSel>              SocClkSel;
constexpr const Register::Class< Descr::PllLockStatus>          PllLockStatus;
