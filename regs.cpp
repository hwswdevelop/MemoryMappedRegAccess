...
*/
...
#if 0
	// So, PllConfig1 and PllConfig7 is the same, but differenet addressed.
	// How to access another register, but don't describe it?
	Register::Class<PllConfig1> pllConfig1; // Use default register address (PLLA)
	Register::Class<PllConfig1> pllConfig7( 0x1201001C );	// Use address of PLLV !!!!!!
	...
	// Reconfigure PLLV PLLV, not a PLLA!!!!!
	pllConfig7.Write<
					 PllConfig1::FracMode,
					 PllConfig1::DacPowerDown,
					 PllConfig1::FoutPowerDown,
					 ...
					 PllConfig1::FBdiv>(
						...
						PllConfig1::Bypass::Type::NoBypass,
						PllConfig1::Refdiv::Type(1),	// 24Mhz / 1 = 24MHz
						PllConfig1::FBdiv::Type(99)	    // 24Mhz * (99 + 1) = 2400MHz. Frac is in integer mode
					 );
#endif
